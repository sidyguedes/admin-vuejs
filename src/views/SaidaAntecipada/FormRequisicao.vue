                ...
                >
                  <template v-slot:activator="{ on, attrs }">
                    <v-text-field
                      ...
                      v-bind="attrs"
                      @blur="date = parseDate(dataSaidaFormatada)"
                      v-on="on"
                    ></v-text-field>
                  </template>
              ...
              <v-col>
                ...
                >
                  ...
                  <v-time-picker
                    ...
                    v-model="saida"
                    full-width
                    @click:minute="$refs.teste.save(saida)"
                  ></v-time-picker>
                </v-menu>
              </v-col>
            </v-row>
                ...
                <v-col align="left" class="col-5">
                  ...
                  >
                    ...
                    <v-time-picker
                      ...
                      v-model="retorno"
                      full-width
                      @click:minute="$refs.menu.save(retorno)"
                    ></v-time-picker>
                  </v-menu>
                </v-col>
              </v-col>
